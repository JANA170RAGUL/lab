...
function AdminEvents() {
  ...
  return (
    <>
      ...
      {/* ================= EVENT TYPES ================= */}
      <Card>
        <h3 style={sectionHeading}>AICTE-Approved Event Types</h3>
        <div
          style={{
            display: "grid",
      ...
      {/* ================= FILTERS ================= */}
      <Card>
        <h3 style={sectionHeading}>Filters & Search</h3>
        <div
          style={{
            display: "grid",
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "16px", marginTop: "12px" }}>
          <input
            style={{ ...filterStyle, width: "50%", boxSizing: "border-box" }}
      ...
      {/* ================= EVENTS TABLE ================= */}
      <Card>
        <h3 style={sectionHeading}>All Events (Governed View)</h3>
        <div className="governed-events-table">
          <style>{`
            .governed-events-table th:nth-child(6),
            .governed-events-table td:nth-child(6) {
        ...
        >
          ...
          >
            ...
            <div style={{ marginTop: "20px" }}>
              ...
              <div style={{ marginTop: "16px", maxWidth: "calc((100% - 20px) / 2 + 13px)" }}>
                <label
                  style={{
                    display: "block",
                    fontSize: "13px",
